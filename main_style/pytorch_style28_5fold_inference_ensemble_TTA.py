...
if __name__ == '__main__':
    ...
    for test_csv in [style_public_test_path, style_private_test_path]:
        ...
        for idx, per_pred_id in enumerate(pred_id):
            ...
            df.to_csv(f'{public_test_path}/Style_model28_5fold_valloss_ensemble_TTA_{PER_MODEL_PREDICT_NUM}_{[x for x in CROP_SIZE_LIST]}.csv', mode='a', index=False, header=False)
