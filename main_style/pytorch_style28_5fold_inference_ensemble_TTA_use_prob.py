...
if __name__ == '__main__':
    ...
    CROP_SIZE_LIST = [13]#要預測的model crop size
    CHANNELS_1 = 4
    NUM_CLASSES = 3
    BATCH_SIZE = 256
    ...
    for test_csv in [style_public_test_path, style_private_test_path]:
        ...
        for pred_id in tqdm.tqdm(keep_dict):
            ...
            df.to_csv(f'{public_test_path}/Style_model28_5fold_valloss_ensemble_TTA_{PER_MODEL_PREDICT_NUM}_{[x for x in CROP_SIZE_LIST]}_use_prob.csv', mode='a', index=False, header=False)    
