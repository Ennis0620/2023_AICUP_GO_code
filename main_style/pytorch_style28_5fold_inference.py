...
if __name__ == "__main__":
    ...
    file_name = f'Style_model28_5fold_channel{CHANNELS_1}_{CROP_SIZE}_fold{FOLD}_valloss_best_submission.csv'
    ...
    for test_csv in [style_public_test_path, style_private_test_path]:
        ...
        Style_test_dataloader = DataLoader(Style_test_dataloader, batch_size=BATCH_SIZE)
