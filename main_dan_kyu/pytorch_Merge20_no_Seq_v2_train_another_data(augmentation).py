...
from models_block.inception_v4_only_reduceA_with_seq import inception_resnet_v2_GO_V3_no_Seq
...
class dataloader(Dataset):
    def __init__(self, csv_path, data_type ,limit_size = 50, split_ratio = 0.2):
        ...
        with open(f'{CURRENT_PATH}/valid_id.txt' , 'r' ) as fp:
...
if __name__ == '__main__':
    ...
    MODEL_NAME = f'Merge_model_CNN20_4channels_valloss_v2'
    EPOCHS = 10000
    LEARNING_RATE = 0.001
    ...
    summary(model, torch.rand(1,CHANNELS_1,19,19).to(DEVICE))
